...
class AllProductsSection extends Component {
  ...
  renderFailureView = () => (
    <div className="products-error-view-cont">
      <img
        className="prod-failure-img"
        src="https://assets.ccbp.in/frontend/react-js/nxt-trendz/nxt-trendz-products-error-view.png"
        alt="products failure"
      />
      <h1 className="prod-failure-head">Oops! Something Went Wrong</h1>
      <p className="prod-failure-descp">
  ...
  renderProductsList = () => {
    ...
    const shouldShowProdList = productsList.length > 0

    return shouldShowProdList ? (
